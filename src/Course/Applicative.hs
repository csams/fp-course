...
lift4 ::
  ...
  -> k d
  -> k e
lift4 f as bs cs ds = f <$> as <*> bs <*> cs <*> ds
...
filtering f (a:.as) = (\b xs-> if b then a:.xs else xs) <$> f a <*> filtering f as
